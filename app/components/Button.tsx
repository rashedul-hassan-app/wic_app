...
const $viewPresets: Record<Presets, ThemedStyleArray<ViewStyle>> = {
  ...
  filled: [$styles.row, $baseViewStyle, ({ colors }) => ({ backgroundColor: colors.elevated })],
...
const $pressedViewPresets: Record<Presets, ThemedStyle<ViewStyle>> = {
  default: ({ colors }) => ({ backgroundColor: colors.elevated }),
  filled: ({ colors }) => ({ backgroundColor: colors.border }),
  reversed: ({ colors }) => ({ backgroundColor: colors.tintLight }),
}
